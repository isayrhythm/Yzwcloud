...
def test_create_diff_analysis_request_defaults_to_r_transcriptomics() -> None:
    request = CreateDiffAnalysisRequest(case_condition="case", control_condition="control")
